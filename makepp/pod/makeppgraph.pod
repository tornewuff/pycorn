...
=for vc $Id: makeppgraph.pod,v 1.11 2008/06/01 21:47:19 pfeiffer Exp $
...
filenames.  There are a few predefined function you can use for this.  These
return true if they did something so you can combine them as in:
...
=item cwd number, name[, separator]
