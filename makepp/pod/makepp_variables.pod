...
=for vc $Id: makepp_variables.pod,v 1.32 2009/02/11 23:22:37 pfeiffer Exp $

=head1 DESCRIPTION

L<B<A>R|/AR>, L</ARFLAGS>, L</AS>,E<nbsp>
L<B<C>C|/CC>, L</CFLAGS>, L</changed_dependencies>, L</changed_inputs>, L</CURDIR>,
  L</CXX>, L</CXXFLAGS>,E<nbsp>
L<B<d>efine|/define>, L</dependencies>, L</dependency>,E<nbsp>
L<B<e>xport|/export>,E<nbsp>
L<B<F>77|/F77>, L</FC>, L</foreach>,E<nbsp>
L<B<g>lobal|/global>,E<nbsp>
L<B<i>nput|/input>, L</inputs>,E<nbsp>
L<B<L>D|/LD>, L</LEX>, L</LIBTOOL>,E<nbsp>
L<B<M>AKE|/MAKE>, L</MAKECMDGOALS>, L</MAKEINFO>, L</makepp_percent_subdirs>,
  L</makepp_require_phony>, L</makepp_simple_concatenation>,E<nbsp>
L<B<o>utput|/output>, L</outputs>,E<nbsp>
L<B<P>WD|/PWD>,E<nbsp>
L<B<R>M|/RM>, L</ROOT>,E<nbsp>
L<B<S>HELL|SHELL>, L</sorted_dependencies>, L</sorted_inputs>, L</stem>,E<nbsp>
L<B<t>arget|/target>, L</targets>,E<nbsp>
L<B<Y>ACC|/YACC>,E<nbsp>
C<=>,
C<:=>,
C<+=>,
C<?=>,
...
many characters, but you will probably confuse the makefile parser if you do
...
L<include statement|makepp_statements/include>) or use C<global> variables.
...
after the statement, i.e. the value starts on the next line.
    ...
    override define VARIABLE +=	# Operator is not optional with override
    ...
    enddef
...
the other two, but before any other parsing happens.  This allows using it for
complete rules and/or conditionals:
...
This variable has no default value, and is not used by makepp.  It is however
the preferred way in older makes to implement recursive make.  That's why
makepp recognizes when this variable is used and turns off some features, even
before the recursion actually takes place.
...
preferably use the builtin L<&rm|makepp_builtins/&rm> command directly.  If
you want to write a phony clean rule, look at the C<makeppclean -r> command
instead.
...
This direct access is however error-prone!  The user may have overriden these
