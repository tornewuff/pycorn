...
=for vc $Id: perl_performance.pod,v 1.7 2008/08/04 21:57:02 pfeiffer Exp $
...
expensive.  Build up the string in memory and print it in one go.
...
that the members can't be accessed by name.  For the sake of comparability we
use numeric keys here:
