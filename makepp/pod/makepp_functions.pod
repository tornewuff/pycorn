...
=for vc $Id: makepp_functions.pod,v 1.36 2008/06/02 20:12:59 pfeiffer Exp $
...
If none of the programs is found, S<C<$(find_program )>> returns the
...
"gcc" anyway.  Otherwise the shell would attempt to execute the source
file and the resulting error message might be really strange.
